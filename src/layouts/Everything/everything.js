...
export default class Everything extends React.Component {
    ...
    componentDidMount() {
        fetch('https://newsapi.org/v2/everything?q=apple&from=2020-09-07&to=2020-09-07&sortBy=popularity&pageSize=5&apiKey=88457320a96b44fc82c11e9c0f244ac5')
        ...
        return(
            <Fragment >
                <Container fluid={true} className="container-card-news">
                    <p className="title-news d-block text-center">Everything</p>
                    <div>
                        <ul>
                            { items.map((article) =>
